...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = { {   KC_ESC,     KC_F1,      KC_F2,      KC_F3,   KC_F4,      KC_F5,   KC_F6,   KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     KC_NO,      KC_PSCR,    KC_PAUS,    KC_SLCK,    KC_NO,      KC_NO,      KC_NO,      KC_NO   },
                ...
                {   KC_LSFT,    KC_UP,      SGUI(KC_N), LT(_FN3,KC_LCTL), KC_FNX2,   KC_SPC,  TG(_FN2), MO(_FN),    KC_RSFT,    KC_RALT,    KC_INT2,    KC_CAPS,    KC_NO,      KC_RSFT,    KC_NO,      KC_UP,      KC_NO,      KC_P1,      KC_P2,      KC_P3,      KC_PENT },
    ...
    [_FN2]  = { {   _______,    KC_MSEL,    KC_VOLD,    KC_VOLU, KC_MUTE,    KC_MSTP, KC_MPRV, KC_MPLY,    KC_MNXT,    KC_MAIL,    KC_WHOM,    KC_CALC,    RGB_TOG,    _______,    KC_PAUS,    _______,    KC_SLEP,    _______,    _______,    _______,    _______ },
                ...
                {   _______,    _______,    _______,    _______, KC_INT5,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    RGB_SPD,    _______,    _______,    _______,    _______,    _______ }
             },
    ...
    [_FN4]  = { {   _______,    _______,    _______,    _______, _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______ },
