...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME]=  { {   KC_ESC,     KC_F1,      KC_F2,      KC_F3,   KC_F4,      KC_F5,   KC_F6,   KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     KC_NO,      KC_PSCR,    KC_SLCK,    KC_PAUS,    KC_NO,      KC_NO,      KC_NO,      KC_NO   },
                ...
                {   KC_LSFT,    KC_NUBS,    SGUI(KC_N), KC_LCTL, KC_LSFT,    KC_SPC,  KC_1,   MO(_COLE),  KC_7,       KC_8,       KC_9,       KC_0,       KC_NO,      KC_RSFT,    KC_NO,      KC_UP,      KC_NO,      KC_MS_BTN2, KC_MS_DOWN, KC_MS_BTN3, KC_PENT },
